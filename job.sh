...
$PYTHON train.py --batch_size=2 --iter_per_epoch 150 --datapath $datapath --savepath $savepath --num_epochs 300 --lr 2e-4 --region_fusion_start_epoch 20 --dataname $dataname

#eval:
#resume=train_models/model_last_brast2020.pth
